...
def dataset_preprocess():
    ...
    dir = './'
    filename = 'DataSet_CPU_Intensive'
    ...
    drop_list = ['task_name', 'Active_Power(W)', 'Activte_Energy(J)', 'Task_Energy_Concumption_Total(J)', 'Used_Time(s)', 'Net_Active_Power(W)', 'Frequency(Hz)',
                 ...
                 # 'program_name'
                 'Current(A)', 'Power_Factor(PF)', 'Container_CPU_Request(%)', 'Container_Memory_Request(MB)', 'Container_GPU_Request', 'Container_IOPS_Request',
                 'Node_Load15', 'Node_Load1', 'Container_GPU_Framebuffer_Mem_Free(MB)', 'Container_GPU_Framebuffer_Mem_Used(MB)',
                 'program_name',
                 'lines_empty_num(assembly code)', 'total_lines_num(assembly code)', 'total_lines_num(source code)', 'lines_empty_num(source code)',
                 'LLC-load-misses', 'LLC-loads', 'L1-dcache-load-misses', 'L1-icache-load-misses', 'LLC-load-misses', 'dTLB-load-misses', 
                 'L1-dcache-loads',  'dTLB-loads',  'Container_Memory_Failures_Total',
                 'iTLB-load-misses',   'L1-dcache-load-misses-rate(%)',
                 'source_file_space_usage(K)', 'file_space_usage(K)', 
                 #'source_code_lines', 'assembly_code_lines', 
                #'Container_Fs_Writes_Merged_Total', 'Container_Memory_Usage_Bytes(MB)', 'Container_Memory_Mapped_File(MB)', 'Container_Memory_Working_Set_Bytes(MB)',
                #'Node_Load5', 'Container_GPU_Temperature(C)', 'Container_Spec_Memory_Limit_Bytes(MB)', 'Container_Memory_Max_Usage_Bytes(MB)',
    ...
    node_drop_list = [
        ...
        'Node_Schedstat_Timeslices_Total(K)', 'Node_Schedstat_Waiting_Seconds_Total(h)', 'Container_Fs_Io_Current',  
         'Node_Memory_Buffers_Bytes(GB)', 'Mode_Memory_MemTotal_Bytes(GB)',
        ...
        'Container_Spec_Memory_Swap_Limit_Bytes(B)', 'Process_Virtual_Memory_Bytes(GB)', 
        'Node_Disk_Reads_Completed_Total(K)', 'Node_Disk_Reads_Merged_Total(K)', 'Node_Disk_Write_Time_Seconds_Total(s)',
        'Node_Disk_Writes_Merged_Total(K)', 'L1-icache-loads', 'iTLB-loads', 'L1-dcache-prefetches', 'L1-dcache-prefetch-misses',
        
        'Container_Fs_Sector_Reads_Total', 'Container_Fs_Sector_Writes_Total', 'Process_Resident_Memory_Bytes(MB)',
    ...
    drop_list = drop_list + time_related_metrics  + node_drop_list + useless_info_list #+ drop_total_metrics_list + extra_info_list
    # drop_list
...
# nohup /media/linux/anaconda3/envs/data_process/bin/python DE_LightGBM_cpu_performance_prediction.py > LightGBM-cpu_performance-output-$(date "+%Y-%m-%d-%H:%M:%S")
