...
def dataset_preprocess():
    ...
    #dataset = dataset[(dataset['Container_GPU_SM_Clocks(MHz)'] > 350)]
    ...
    extra_info_list = [
        ...
        'br_inst_retired.all_branches.1', 'inst_retired.any#IpFarBranch','br_inst_retired.far_branch:u','L1-dcache-loads','L1-dcache-load-misses','LLC-loads',
    ...
    node_drop_list = [
        ...
        'Node_Disk_Io_Now', 'Node_Disk_Read_Bytes_Total(MB)', 
        'Node_Disk_Written_Bytes_Total(MB)','Node_Filefd_Allocated','Node_Filesystem_Files(M)','Node_Filesystem_Files_Free(M)',
        ...
        'Process_Resident_Memory_Bytes(MB)', 'Node_Memory_MemFree_Bytes(GB)', 'Node_Memory_SwapFree_Bytes(GB)', 'Node_Memory_SwapTotal_Bytes(GB)', 'Node_Memory_Cached_Bytes(GB)',
    ...
    time_related_metrics = [
        ...
        #'Node_Disk_Reads_Completed_Total(K)', 'Node_Disk_Reads_Merged_Total(K)', 'Node_Disk_Writes_Merged_Total(K)', 
        #'Node_Disk_Write_Time_Seconds_Total(s)', 'Node_Disk_Reads_Completed_Total(K)', 
    ]
    ...
    drop_list = drop_list + extra_info_list + node_drop_list + time_related_metrics #+ drop_total_metrics_list
    # drop_list
...
def main():
    ...
    parameter = {
        ...
        # 'max_depth': (1, 9), #int
        # 'feature_fraction': (0.0, 1.05), # float
        # 'bagging_fraction': (0.0, 1.05), # float
        # 'learning_rate': (0.05, 0.30), # float
        # 'early_stopping_rounds': (25, 100), # int
        # 'n_important_features': (5, 36), # int
        # 'num_leaves': (4, 156), # int
        # 'max_bin': (16, 500), # int
        # 'min_data_in_leaf': (1, 120), # int
        # 'min_split_gain': (-0.1, 1.1), # float
        # 'lambda_l1': (-0.1, 1.1), # float
        # 'lambda_l2': (-0.1, 1.1), # float
        'num_boost_round': (200, 600), #int
        'bagging_freq': (0, 100), #int
        'max_depth': (1, 9), #int
    ...
    result = differential_evolution(parameter_tuning_objective_func, bounds=bounds, args=(test_set_ratio, keys, feature_names, df_X, df_Y))
...
# nohup /media/linux/anaconda3/envs/data_process/bin/python DE_LightGBM_cpu_power_prediction.py > LightGBM-output-$(date "+%Y-%m-%d-%H:%M:%S")
