...
def dataset_preprocess():
    ...
    drop_list = ['task_name', 'Active_Power(W)', 'Activte_Energy(J)', 'Task_Energy_Concumption_Total(J)', 'Used_Time(s)', 'Net_Active_Power(W)', 'Frequency(Hz)',
        ...
        'Node_Load15', 'Node_Load1', 'Container_GPU_Framebuffer_Mem_Free(MB)', #'Container_GPU_Framebuffer_Mem _Used(MB)',
        'p_name1', 'p_name2', 'source_file_space_usage(K)', 'kernel_file_space_usage(K)',
        'lines_empty_num(kernel_code)', 'total_lines_num(kernel_code)', 'total_lines_num(source_code)', 'lines_empty_num(source_code)',
    ...
    node_drop_list = [
        ...
        'Node_Disk_Writes_Merged_Total(K)', 'Container_Memory_Mapped_File(MB)', 'Container_Memory_Max_Usage_Bytes(MB)', 'Container_Memory_Working_Set_Bytes(MB)',
        'Container_Memory_Failures_Total', 'Container_Memory_Usage_Bytes(MB)', 'Node_Procs_Blocked', 'Container_Fs_Writes_Merged_Total'
...
# nohup /media/linux/anaconda3/envs/data_process/bin/python DE_LightGBM_gpu_power_prediction.py > LightGBM-gpu-power-output-$(date "+%Y-%m-%d-%H:%M:%S")
