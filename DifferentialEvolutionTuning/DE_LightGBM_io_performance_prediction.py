...
def parameter_tuning_objective_func(X, *args):
    ...
    feature_names = ['Node_Procs_Blocked', 'Container_Fs_Writes_Total', 'Container_Memory_Failures_Total', 'Node_Procs_Running', 'Container_CPU_USAGE(%)', 'Container_Memory_Cached(MB)', 'Container_Memory_Usage(MB)', 'Container_Fs_Writes_Bytes_Total(MB)', 'Container_Memory_Mapped_File(MB)'] 
...
def dataset_preprocess():
    ...
    drop_list = ['task_name', 'Active_Power(W)', 'Activte_Energy(J)', 'Task_Energy_Concumption_Total(J)', 'Used_Time(s)', 'Net_Active_Power(W)', 'Frequency(Hz)',
        ...
        #     'Container_Memory_Cached(MB)',  'Node_Procs_Blocked',
        # 'Container_Memory_Mapped_File(MB)', 'Node_Intr_Total(K)',
        # "Node_Load5",
        # "Container_Memory_Working_Set_Bytes(MB)",
        'Container_Received_Network_Traffic(B)',
        'Container_Sent_Network_Traffic(B)',
        # 'L1-dcache-load-misses-rate(%)',
        # 'Node_Intr_Total(K)',
        #'LLC-load-misses-rate(%)',
        #'dTLB-load-misses-rate(%)',
        'Container_Memory_Usage_Bytes(MB)',
        # 'Container_Memory_Max_Usage_Bytes(MB)',
        #'input_file_size(MB)',
    ]
...
def main():
    ...
    parameter = {
        ...
        'max_depth': (1, 9), #int
        'feature_fraction': (0.95, 1.05), # float
        'bagging_fraction': (0.95, 1.05), # float
...
# nohup /media/linux/anaconda3/envs/data_process/bin/python DE_LightGBM_io_performance_prediction.py > LightGBM-io-performance-output-$(date "+%Y-%m-%d-%H:%M:%S")
