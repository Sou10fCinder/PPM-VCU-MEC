...
def dataset_preprocess():
    ...
    drop_list = ['task_name', 'Active_Power(W)', 'Activte_Energy(J)', 'Task_Energy_Concumption_Total(J)', 'Used_Time(s)', 'Net_Active_Power(W)', 'Frequency(Hz)',
        ...
        'Container_Memory_Working_Set_Bytes(MB)',  'Node_Load5',
    ]
...
# l
# nohup /media/linux/anaconda3/envs/data_process/bin/python DE_xgboost_io_performance_prediction.py > XGBoost-output-io-performance-$(date "+%Y-%m-%d-%H:%M:%S")
