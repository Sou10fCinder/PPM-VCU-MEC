...
def main():
    ...
    params = {
        ...
        "learning_rate": 0.01967723601688535,
        "early_stopping_rounds": 76,
        "n_important_features": 32,
        "num_leaves": 10,
        "max_bin": 229,
        "min_data_in_leaf": 57,
        "min_split_gain": 0.2942865368499024,
        "lambda_l1": 0.6555178297270302,
        "lambda_l2": 0.24641057861805787,
    }
    ...
    R2 = r2_score(y_test, bst.predict(X_test))
