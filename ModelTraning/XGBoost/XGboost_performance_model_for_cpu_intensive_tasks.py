...
def main():
    ...
    params = {
        "n_estimators": 424,
        "min_child_weight": 2,
        "eta": 0.09852200350476811,
        "colsample_bytree": 0.9104627186301498,
        "max_depth": 5,
        "subsample": 0.4264527283954195,
        "lambda": 0.25256591622794444,
        "learning_rate": 0.06515764806668883,
    ...
    print(
        "The R square (R2) on test set: {:.4f}".format(
            r2_score(dtest.get_label(), bst.predict(dtest))
        )
    )
    print(
